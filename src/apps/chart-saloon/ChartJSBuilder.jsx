    ...
    <div className="min-h-screen bg-gradient-to-br from-amber-950 via-orange-900 to-amber-950 p-4">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-6">
          <h1 className="text-5xl font-bold text-white mb-2">🍺 The Chart Saloon</h1>
          <p className="text-amber-200 mb-2 italic">"Where data comes to drink - Fastest charts in the West"</p>
